  ...
  return (
    ...
    >
      ...
      >
        ...
        <button className="bg-primary/10 text-primary border border-primary/50 px-5 py-2 rounded-md text-xs font-mono font-bold hover:bg-primary hover:text-background-dark transition-all shadow-[0_0_15px_rgba(201,167,74,0.15)] btn-magnetic">
          &gt; ENTRAR_LISTA
        </button>
      </div>
    </nav>
